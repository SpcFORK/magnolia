RUN = go run -race .
LDFLAGS = -ldflags="-s -w"
INCLUDES = runners:test/runners,std.test:test/std.test,build:test/build,bitwise.test:test/bitwise.test.oak,bmp.test:test/bmp.test.oak,build.test:test/build.test.oak,class.test:test/class.test.oak,cli.test:test/cli.test.oak,crypto.test:test/crypto.test.oak,datetime.test:test/datetime.test.oak,debug.test:test/debug.test.oak,fmt.test:test/fmt.test.oak,go.test:test/go.test.oak,gpu.test:test/gpu.test.oak,gui.test:test/gui.test.oak,http.test:test/http.test.oak,import-ext.test:test/import-ext.test.oak,json.test:test/json.test.oak,macro.test:test/macro.test.oak,math.test:test/math.test.oak,md.test:test/md.test.oak,pack.test:test/pack.test.oak,path.test:test/path.test.oak,random.test:test/random.test.oak,shell.test:test/shell.test.oak,sort.test:test/sort.test.oak,std.test:test/std.test.oak,str.test:test/str.test.oak,syntax.test:test/syntax.test.oak,syscall.test:test/syscall.test.oak,thread.test:test/thread.test.oak,transpile.test:test/transpile.test.oak,vfs-bundle.test:test/vfs-bundle.test,virtual.test:test/virtual.test,VirtualToken.test:test/VirtualToken.test,websocket.test:test/websocket.test,windows.test:test/windows.test.oak,Linux.test:test/Linux.test.oak,writes.test:test/writes.test.oak
