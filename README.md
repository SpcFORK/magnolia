...
Comprehensive docs for every module live in [docs/](docs/). The [docs/spec/](docs/spec/) directory contains **184 detailed specification files** (generated via `--doc`) mirroring the stdlib — one per module — covering every function signature, data structure, and usage pattern. It also contains **189 Mermaid dependency graphs** (`.mmd` files) showing the full transitive import tree for each module, generated via `--graph`.
...
<details>
<summary><strong>Dependency Graphs</strong> (189 <code>.mmd</code> files)</summary>

The [docs/spec/](docs/spec/) directory also contains Mermaid dependency graphs for every stdlib module, generated with `magnolia build --graph`. Each `.mmd` file shows the full transitive import tree with modules grouped into family subgraphs. GitHub renders these natively.

- **Syntax & AST** — [syntax.mmd](docs/spec/syntax.mmd) · [syntax-tokenize.mmd](docs/spec/syntax-tokenize.mmd) · [syntax-parse.mmd](docs/spec/syntax-parse.mmd) · [syntax-print.mmd](docs/spec/syntax-print.mmd) · [syntax-macros.mmd](docs/spec/syntax-macros.mmd) · [syntaxfmt.mmd](docs/spec/syntaxfmt.mmd) · [ast-analyze.mmd](docs/spec/ast-analyze.mmd) · [ast-transform.mmd](docs/spec/ast-transform.mmd) · [ast-java.mmd](docs/spec/ast-java.mmd) · [ast-js.mmd](docs/spec/ast-js.mmd) · [ast-lua.mmd](docs/spec/ast-lua.mmd) · [ast-ts.mmd](docs/spec/ast-ts.mmd)
- **Build & Bundling** — [build.mmd](docs/spec/build.mmd) · [build-analyze.mmd](docs/spec/build-analyze.mmd) · [build-ast.mmd](docs/spec/build-ast.mmd) · [build-config.mmd](docs/spec/build-config.mmd) · [build-ident.mmd](docs/spec/build-ident.mmd) · [build-imports.mmd](docs/spec/build-imports.mmd) · [build-includes.mmd](docs/spec/build-includes.mmd) · [build-render.mmd](docs/spec/build-render.mmd) · [build-render-node.mmd](docs/spec/build-render-node.mmd) · [bundle-ast.mmd](docs/spec/bundle-ast.mmd) · [bundle-utils.mmd](docs/spec/bundle-utils.mmd)
- **Audio** — [audio.mmd](docs/spec/audio.mmd) · [audio-aiff.mmd](docs/spec/audio-aiff.mmd) · [audio-au.mmd](docs/spec/audio-au.mmd) · [audio-complex.mmd](docs/spec/audio-complex.mmd) · [audio-dsp.mmd](docs/spec/audio-dsp.mmd) · [audio-fft.mmd](docs/spec/audio-fft.mmd) · [audio-ogg.mmd](docs/spec/audio-ogg.mmd) · [audio-raw.mmd](docs/spec/audio-raw.mmd) · [audio-wav.mmd](docs/spec/audio-wav.mmd)
- **AI & Machine Learning** — [ai.mmd](docs/spec/ai.mmd) · [ai-data.mmd](docs/spec/ai-data.mmd) · [ai-decode.mmd](docs/spec/ai-decode.mmd) · [ai-linalg.mmd](docs/spec/ai-linalg.mmd) · [ai-ml.mmd](docs/spec/ai-ml.mmd) · [ai-nn.mmd](docs/spec/ai-nn.mmd) · [ai-optim.mmd](docs/spec/ai-optim.mmd) · [ai-text.mmd](docs/spec/ai-text.mmd) · [ai-vec.mmd](docs/spec/ai-vec.mmd)
- **GUI Core** — [GUI.mmd](docs/spec/GUI.mmd) · [gui-2d.mmd](docs/spec/gui-2d.mmd) · [gui-3dmath.mmd](docs/spec/gui-3dmath.mmd) · [gui-aa.mmd](docs/spec/gui-aa.mmd) · [gui-accessibility.mmd](docs/spec/gui-accessibility.mmd) · [gui-audio.mmd](docs/spec/gui-audio.mmd) · [gui-canvas.mmd](docs/spec/gui-canvas.mmd) · [gui-clipboard.mmd](docs/spec/gui-clipboard.mmd) · [gui-color.mmd](docs/spec/gui-color.mmd) · [gui-common.mmd](docs/spec/gui-common.mmd) · [gui-dialogs.mmd](docs/spec/gui-dialogs.mmd) · [gui-draw.mmd](docs/spec/gui-draw.mmd) · [gui-draw-ops.mmd](docs/spec/gui-draw-ops.mmd) · [gui-events.mmd](docs/spec/gui-events.mmd) · [gui-filedrop.mmd](docs/spec/gui-filedrop.mmd) · [gui-fonts.mmd](docs/spec/gui-fonts.mmd) · [gui-form.mmd](docs/spec/gui-form.mmd) · [gui-gamepad.mmd](docs/spec/gui-gamepad.mmd) · [gui-gpu-info.mmd](docs/spec/gui-gpu-info.mmd) · [gui-graph.mmd](docs/spec/gui-graph.mmd) · [gui-input.mmd](docs/spec/gui-input.mmd) · [gui-leak-detect.mmd](docs/spec/gui-leak-detect.mmd) · [gui-lighting.mmd](docs/spec/gui-lighting.mmd) · [gui-loop.mmd](docs/spec/gui-loop.mmd) · [gui-menus.mmd](docs/spec/gui-menus.mmd) · [gui-mesh.mmd](docs/spec/gui-mesh.mmd) · [gui-print.mmd](docs/spec/gui-print.mmd) · [gui-raster.mmd](docs/spec/gui-raster.mmd) · [gui-render.mmd](docs/spec/gui-render.mmd) · [gui-resolution.mmd](docs/spec/gui-resolution.mmd) · [gui-systray.mmd](docs/spec/gui-systray.mmd) · [gui-test.mmd](docs/spec/gui-test.mmd) · [gui-theme.mmd](docs/spec/gui-theme.mmd) · [gui-thread.mmd](docs/spec/gui-thread.mmd) · [gui-video.mmd](docs/spec/gui-video.mmd) · [gui-web.mmd](docs/spec/gui-web.mmd)
- **GUI Shaders** — [gui-shader.mmd](docs/spec/gui-shader.mmd) · [gui-shader-codegen.mmd](docs/spec/gui-shader-codegen.mmd) · [gui-shader-color.mmd](docs/spec/gui-shader-color.mmd) · [gui-shader-math.mmd](docs/spec/gui-shader-math.mmd) · [gui-shader-noise.mmd](docs/spec/gui-shader-noise.mmd) · [gui-shader-sdf.mmd](docs/spec/gui-shader-sdf.mmd)
- **GUI Native Windows** — [gui-native-win.mmd](docs/spec/gui-native-win.mmd) · [gui-native-win-close.mmd](docs/spec/gui-native-win-close.mmd) · [gui-native-win-d3d11.mmd](docs/spec/gui-native-win-d3d11.mmd) · [gui-native-win-ddraw.mmd](docs/spec/gui-native-win-ddraw.mmd) · [gui-native-win-frame.mmd](docs/spec/gui-native-win-frame.mmd) · [gui-native-win-icons.mmd](docs/spec/gui-native-win-icons.mmd) · [gui-native-win-opengl.mmd](docs/spec/gui-native-win-opengl.mmd) · [gui-native-win-poll.mmd](docs/spec/gui-native-win-poll.mmd) · [gui-native-win-present.mmd](docs/spec/gui-native-win-present.mmd) · [gui-native-win-probe.mmd](docs/spec/gui-native-win-probe.mmd) · [gui-native-win-vulkan.mmd](docs/spec/gui-native-win-vulkan.mmd) · [gui-native-win-vulkan-constants.mmd](docs/spec/gui-native-win-vulkan-constants.mmd) · [gui-native-win-vulkan-init.mmd](docs/spec/gui-native-win-vulkan-init.mmd) · [gui-native-win-vulkan-present.mmd](docs/spec/gui-native-win-vulkan-present.mmd) · [gui-native-win-vulkan-swapchain.mmd](docs/spec/gui-native-win-vulkan-swapchain.mmd)
- **GUI Native Linux** — [gui-native-linux.mmd](docs/spec/gui-native-linux.mmd)
- **Data Formats** — [data.mmd](docs/spec/data.mmd) · [data-csv.mmd](docs/spec/data-csv.mmd) · [data-ini.mmd](docs/spec/data-ini.mmd) · [data-toml.mmd](docs/spec/data-toml.mmd) · [data-xml.mmd](docs/spec/data-xml.mmd) · [data-yaml.mmd](docs/spec/data-yaml.mmd) · [json.mmd](docs/spec/json.mmd) · [md.mmd](docs/spec/md.mmd) · [msgpack.mmd](docs/spec/msgpack.mmd)
- **Image Formats** — [image.mmd](docs/spec/image.mmd) · [image-bmp.mmd](docs/spec/image-bmp.mmd) · [image-ico.mmd](docs/spec/image-ico.mmd) · [image-ppm.mmd](docs/spec/image-ppm.mmd) · [image-qoi.mmd](docs/spec/image-qoi.mmd) · [image-tga.mmd](docs/spec/image-tga.mmd)
- **Compression** — [compression.mmd](docs/spec/compression.mmd) · [compression-huffman.mmd](docs/spec/compression-huffman.mmd) · [compression-lzw.mmd](docs/spec/compression-lzw.mmd) · [compression-rle.mmd](docs/spec/compression-rle.mmd)
- **Networking** — [http.mmd](docs/spec/http.mmd) · [p2p.mmd](docs/spec/p2p.mmd) · [socket.mmd](docs/spec/socket.mmd) · [websocket.mmd](docs/spec/websocket.mmd) · [WLAN.mmd](docs/spec/WLAN.mmd) · [email.mmd](docs/spec/email.mmd) · [email-imap.mmd](docs/spec/email-imap.mmd) · [email-pop.mmd](docs/spec/email-pop.mmd) · [email-smtp.mmd](docs/spec/email-smtp.mmd) · [imap.mmd](docs/spec/imap.mmd) · [pop.mmd](docs/spec/pop.mmd) · [smtp.mmd](docs/spec/smtp.mmd)
- **Crypto & Security** — [crypto.mmd](docs/spec/crypto.mmd) · [dataprot.mmd](docs/spec/dataprot.mmd)
- **Math** — [math.mmd](docs/spec/math.mmd) · [math-base.mmd](docs/spec/math-base.mmd) · [math-geo.mmd](docs/spec/math-geo.mmd) · [math-stats.mmd](docs/spec/math-stats.mmd)
- **Runtime & VMs** — [Virtual.mmd](docs/spec/Virtual.mmd) · [Virtual-Bytecode.mmd](docs/spec/Virtual-Bytecode.mmd) · [VirtualToken.mmd](docs/spec/VirtualToken.mmd) · [wasm-vm.mmd](docs/spec/wasm-vm.mmd) · [wasm-vm-runtime.mmd](docs/spec/wasm-vm-runtime.mmd) · [runtime-native.mmd](docs/spec/runtime-native.mmd) · [runtime-js.mmd](docs/spec/runtime-js.mmd) · [runtime-codegen.mmd](docs/spec/runtime-codegen.mmd) · [codegen-common.mmd](docs/spec/codegen-common.mmd)
- **Platform — Windows** — [windows.mmd](docs/spec/windows.mmd) · [windows-constants.mmd](docs/spec/windows-constants.mmd) · [windows-core.mmd](docs/spec/windows-core.mmd) · [windows-flags.mmd](docs/spec/windows-flags.mmd) · [windows-kernel.mmd](docs/spec/windows-kernel.mmd) · [windows-gdi.mmd](docs/spec/windows-gdi.mmd) · [windows-fonts.mmd](docs/spec/windows-fonts.mmd) · [windows-windowing.mmd](docs/spec/windows-windowing.mmd) · [windows-registry.mmd](docs/spec/windows-registry.mmd) · [windows-net.mmd](docs/spec/windows-net.mmd) · [windows-loader.mmd](docs/spec/windows-loader.mmd) · [win-common.mmd](docs/spec/win-common.mmd)
- **Platform — Linux** — [Linux.mmd](docs/spec/Linux.mmd) · [linux-constants.mmd](docs/spec/linux-constants.mmd) · [linux-core.mmd](docs/spec/linux-core.mmd) · [linux-libc.mmd](docs/spec/linux-libc.mmd) · [linux-fonts.mmd](docs/spec/linux-fonts.mmd) · [linux-loader.mmd](docs/spec/linux-loader.mmd) · [linux-windowing.mmd](docs/spec/linux-windowing.mmd)
- **Core & Utilities** — [std.mmd](docs/spec/std.mmd) · [str.mmd](docs/spec/str.mmd) · [fmt.mmd](docs/spec/fmt.mmd) · [fs.mmd](docs/spec/fs.mmd) · [path.mmd](docs/spec/path.mmd) · [cli.mmd](docs/spec/cli.mmd) · [shell.mmd](docs/spec/shell.mmd) · [sort.mmd](docs/spec/sort.mmd) · [random.mmd](docs/spec/random.mmd) · [datetime.mmd](docs/spec/datetime.mmd) · [bitwise.mmd](docs/spec/bitwise.mmd) · [test.mmd](docs/spec/test.mmd) · [debug.mmd](docs/spec/debug.mmd) · [sys.mmd](docs/spec/sys.mmd) · [thread.mmd](docs/spec/thread.mmd) · [async-event-bus.mmd](docs/spec/async-event-bus.mmd) · [video.mmd](docs/spec/video.mmd) · [writes.mmd](docs/spec/writes.mmd) · [codecols.mmd](docs/spec/codecols.mmd) · [gpu.mmd](docs/spec/gpu.mmd) · [gpus.mmd](docs/spec/gpus.mmd) · [transpile.mmd](docs/spec/transpile.mmd) · [mermaid.mmd](docs/spec/mermaid.mmd) · [pack.mmd](docs/spec/pack.mmd) · [pack-utils.mmd](docs/spec/pack-utils.mmd)
